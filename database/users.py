...
class User(db.base):
    ...
    def __init__(self, user_id: int, is_protected: bool = False, is_white: bool = False, is_black: bool = False):
    ...
    def __str__(self):
        return f"{self.user_id}, {self.is_protected}, {self.is_white}, {self.is_black}"
    ...
    @staticmethod
    def get_protected() -> list[int]:
        users: list["User"] = db.session.query(User) \
            .filter_by(is_protected=True) \
            .all()
